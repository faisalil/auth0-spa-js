...
var oauthToken = function (_a, worker) {
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        case 0:
          item = __assign({ redirect_uri: window.location.origin }, options);
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        ...
        cache = this.cache.get(
          __assign({ client_id: this.options.client_id }, options)
        );
        return [
          2 /*return*/,
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          ...
          case 2:
            _c.sent();
            if (!!ignoreCache) return [3 /*break*/, 4];
            cache = this.cache.get(
              {
            ...
            if (!(cache && cache.access_token)) return [3 /*break*/, 4];
            return [4 /*yield*/, lock.releaseLock(GET_TOKEN_SILENTLY_LOCK_KEY)];
          case 3:
            _c.sent();
            return [2 /*return*/, cache.access_token];
          case 4:
            if (!this.options.useRefreshTokens) return [3 /*break*/, 6];
            return [
              4 /*yield*/,
