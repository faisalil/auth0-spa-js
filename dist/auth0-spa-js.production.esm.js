...
var ie,
  ...
  Oe = function (e, t) {
    for (var n = xe(t), r = W.f, o = R.f, i = 0; i < n.length; i++) {
      var a = n[i];
      x(e, a) || r(e, a, o(t, a));
    }
  },
  ...
  je = function (e, t) {
    var n = Ke[Ee(e)];
    return n == Ce || (n != Re && ('function' == typeof t ? f(t) : !!t));
  },
    ...
    if ((n = s ? l : u ? l[c] || Z(c, {}) : (l[c] || {}).prototype))
      for (r in t) {
        if (
          ...
          !Ae(s ? r : c + (u ? '.' : '#') + r, e.forced) && void 0 !== o)
        ) {
  ...
  Me = Math.min,
  He = Ne('startsWith'),
  qe = !(He || ((ie = De(String.prototype, 'startsWith')), !ie || ie.writable));
Pe(
...
var kt =
  ...
  Et =
    ...
    ('__proto__' in {}
      ...
      : void 0),
  Kt = yt.IteratorPrototype,
  Rt = yt.BUGGY_SAFARI_ITERATORS,
  Ct = Fe('iterator'),
  At = function () {
    return this;
  },
    ...
    if (
      (m &&
        ...
        Kt !== Object.prototype &&
          c.next &&
          (ft(c) !== Kt &&
            (Et ? Et(c, Kt) : 'function' != typeof c[Ct] && P(c, Ct, At)),
          xt(c, f, !0))),
      'values' == o &&
        h &&
        'values' !== h.name &&
      ...
      if (
        ...
        for (u in s) (Rt || d || !(u in p)) && ce(p, u, s[u]);
      else Pe({ target: t, proto: !0, forced: Rt || d }, s);
    return s;
  },
  Pt = at.charAt,
  Zt = ae.set,
    ...
    for (
      var n = xn.call(In(this), e, t),
        r = (function (e, t) {
          var n,
            r = C(e).constructor;
          return void 0 === r || null == (n = C(r)[kn]) ? t : tt(n);
  ...
  An = (function (e, t) {
    ...
    return (Kn[e] =
      ...
      !f(function () {
        if (r && !d) return !0;
        var e = { length: -1 };
        r ? En(e, 1, { enumerable: !0, get: Rn }) : (e[1] = 1), n.call(e, o, i);
      }));
      ...
      return i(this, function (i) {
        switch (i.label) {
          ...
          case 1:
            ...
            i.label = 2;
          case 2:
            return i.trys.push([2, 4, , 5]), [4, Rr(e, n, a, c, s, t)];
          case 3:
